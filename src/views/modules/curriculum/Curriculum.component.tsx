...
function CurriculumModule() {
                ...
                <div>
                    <ul>
                        {faculties.map((faculty) => (
                            <li style={{ marginBottom: 10 }} key={faculty}>
    ...
    const callDeleteApi = (id: string) => {
        curriculumService.delete({
            ...
            onSuccess: (res: ApiResponse) => {
                ...
                callListApi();
                message.success('Xoá chương trình đào tạo thành công');
            },
            onError: (err) => {
                message.error('Lỗi khi xoá chương trình đào tạo');
                console.log('err', err);
            },
        });
    };
    ...
    const showConfirm = (id: string) => {
        confirm({
            title: 'Bạn có muốn xoá chuơng trình đào tạo này không?',
            ...
            <div className={cx('wrapper-table')}>
                <div className={cx('wrapper-above')}>
                    ...
                    <Button
                        ...
                        onClick={() => handleEdit('/curriculum/create')}
                    >
                        Tạo mới
                    </Button>
                </div>
